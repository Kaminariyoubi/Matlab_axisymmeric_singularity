...
Then, according to the paper, we could directly obtain the time derivatives of $S(t)$:
$$
\begin{aligned}
    \dot{S}(t) &= 4 {f}^2 S(t)^2 \left[ \ln \left| \frac{1 - {f} S(t)}{1 + {f} S(t)} \right| \right]^{-2}\label{rs}\,,\\[2pt]
